...
def mailContentNota(pdfPath,nomerNota):
    ...
    msg.attach(att1)
    return msg
def toDocx(nomerNota,noNota,perihal,tableList,tempatTanggal,imageList):
    docPath = "..\..\\template\\nota\\NOTA.docx"
    ...
    docxFolder = structFolderMan(os.environ['USERPROFILE']+'\\NOTA TRIP NUMBER BARU','PLP',getDashDate())
